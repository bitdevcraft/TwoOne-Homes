...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TwoOneHomes.Domain.Users.Permission", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("character varying(26)");
            ...
            modelBuilder.Entity("TwoOneHomes.Domain.Users.RefreshToken", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("character varying(26)");
            ...
            modelBuilder.Entity("TwoOneHomes.Domain.Users.Role", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("character varying(26)");
            ...
            modelBuilder.Entity("TwoOneHomes.Domain.Users.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("TwoOneHomes.Domain.Users.UserActivity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("character varying(26)");
            ...
            modelBuilder.Entity("TwoOneHomes.Domain.Users.UserRole", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("character varying(26)");
            ...
            modelBuilder.Entity("TwoOneHomes.Domain.Users.RolePermission", b =>
                {
                    b.HasOne("TwoOneHomes.Domain.Users.Permission", "Permission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TwoOneHomes.Domain.Users.Role", "Role")
                        .WithMany("RolePermissions")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Ulid>", b =>
                {
                    b.HasOne("TwoOneHomes.Domain.Users.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
